...
+++
我最近在学习 Linux 系统编程，为了搞明白 Linux 系统远程登录的技术细节，我想找到 telnet 客户端和服务器端相关源代码来阅读。搜索一番之后，虽然找到了 Go 或 Java 版本的 telnet，但我更想看 C 版本的代码。于是，我想为什么不下载 Linux 发行版中 telnet 软件包的源代码来看呢？
<!--more-->
# CentOS
